...
version: "1.0"
name: Resend
description: "The typography system is the star of the show. Three carefully chosen typefaces create a hierarchy that feels both editorial and technical: Domaine Display (a Klim Type Foundry serif) appears at massive 96px for hero headlines with barely-there line-height (1."
source:
...
preview_tokens:
  ...
  button_secondary_border: "#f0f0f0"
  button_tertiary_text: "#ff801f"
  surface_bg: "#ffffff"
  card_bg: "#ffffff"
  text: "#000000"
  text_muted: "#f0f0f0"
...
_Note: Resend uses a minimal breakpoint system — only 480px and 600px detected. The design is desktop-first with a clean mobile collapse._
